...
if (isset($_POST['update_sale'])) {
  ...
  if (empty($errors)) {
    ...
    if ($result && $db->affected_rows() === 1) {
      ...
      $session->msg('s', "Cập nhật bán hàng.");
    ...
    <div class="panel">
      <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
          <a href="sales.php" class="btn btn-primary">Hiển thị tất cả</a>
        </div>
      </div>
          ...
          <tbody id="product_info">
            <tr>
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_name">
                  <input type="text" class="form-control" id="sug_input" name="Tiêu đề" value="<?php echo remove_junk($product['name']); ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary">Cập nhật</button>
                </td>
              </form>
            </tr>
          </tbody>
