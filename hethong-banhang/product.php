        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-center" style="width: 10%;"> Sản phẩm đã thêm </th>
            ...
            <?php foreach ($products as $product) : ?>
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_product.php?id=<?php echo (int)$product['id']; ?>" class="btn btn-info btn-xs" title="Sửa" data-toggle="tooltip">
