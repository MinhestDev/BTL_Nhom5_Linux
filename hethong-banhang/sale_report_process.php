...
<head>
  ...
  <title>Tiêu đề trang mặc định</title>
...
<body>
      ...
      <table class="table table-border">
        ...
        <tfoot>
          <tr class="text-right">
            ...
            <td>
              <?php echo number_format(total_price($results)[0], 0); ?> vnđ
            </td>
          </tr>
          <tr class="text-right">
            <td colspan="4"></td>
            <td colspan="1">Lợi nhuận</td>
            <td><?php echo number_format(total_price($results)[1], 0); ?></td> vnđ
          </tr>
        </tfoot>
      </table>
    </div>
  <?php
    ...
    $session->msg("d", "Xin lỗi không có sản phẩm nào được tìm thấy. ");
    redirect('sales_report.php', false);
  endif;
  ?>
</body>
